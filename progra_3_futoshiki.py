...
def acerca_de():
    ...
    return messagebox.showinfo(message="Creado por: Wander Jimenez Calvo\n Ultima actualizacion: 28/06/2021")
...
button3 = tkinter.Button(ventana, text="Ayuda", bg="#AAAAAA", fg="white",command=ayuda).place(x=197,y=130)
acerca = tkinter.Button(ventana, text="Acerca de",bg="#AAAAAA", fg="white",width=11,command=acerca_de).place(x=105,y=100)
